...
export default function Example() {
  ...
  return (
    <div className="bg-white">
          ...
          <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            ...
            <div className="mt-6 flow-root">
              <div className="-my-6 divide-y divide-gray-500/10">
                ...
                <div className="py-6">
                  <a
                    href="https://sekai.best/chara/10"
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8" class="bg-cover bg-center bg-image-url">
        <div
        ...
        <div className="mx-auto max-w-2xl py-28 sm:py-28 lg:py-26">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div>
              <p  className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">Yokoso Watashi Soul Society</p>
            </div>
          </div>
          <div className="text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <a href="Video" className="text-sm font-semibold leading-6 text-gray-900">
